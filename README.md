...
transition: transform .34s cubic-bezier(.4,0,.2,1) .06s,
...
.di-track.active { background: rgba(255,255,255,.1); }
...
<div class="di-root" id="diRoot">
  <div class="di-island di-player" id="diPlayer">
    <div class="di-player-hdr" id="diPlayerHdr">
      ...
      <div class="di-wave paused" id="diWave">
        <span style="--d:.7s;--dl:0s"></span>
        <span style="--d:1.1s;--dl:.1s"></span>
        <span style="--d:.9s;--dl:.2s"></span>
        <span style="--d:1.3s;--dl:.3s"></span>
      </div>
    </div>
  ...
  <div class="di-island di-list" id="diList">
    <div class="di-list-hdr" id="diListHdr">
      ...
      <svg class="di-chevron" width="11" height="11" viewBox="0 0 24 24" fill="none"
           stroke="rgba(255,255,255,.32)" stroke-width="2.5"
           stroke-linecap="round" stroke-linejoin="round">
